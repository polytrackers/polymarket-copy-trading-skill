...
MCP catalog fingerprint: sha256-846b2211b30391f67c0209084b258ce213cb96ee5cc58bcec1e8aa76a3b58aed
...
- Internal Copy Receipt evidence: Elite `signals:read` keys can call `pt_copy_replication_aggregates_get` for one exact whale or a bounded 1–50 row cohort. The MCP-only wrapper preserves the database's null scored metrics below 20 distinct settled conditions; medium begins at 20 and high requires 40+ plus at least 75% complete receipts. Treat the result as internal prototype evidence, never as a public copy score or recommendation.
